...
<div className="p-3 mb-2 bg-dark text-light rounded-3"
  ...
  <label class="form-check-label" for="exampleRadios2">
    ALL
          ...
          <div class="form-check">
            <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios1" value="shirt" onChange={this.handleSearchArea} />
              <label class="form-check-label" for="exampleRadios1">
               Shirt
          </label>
          </div>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios2" value="short" onChange={this.handleSearchArea}/>
  <label class="form-check-label" for="exampleRadios2">
 Short
  </label>
</div>
<div class="form-check">
  <input class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="tshirt" onChange={this.handleSearchArea}/>
  <label class="form-check-label" for="exampleRadios3">
   T-Shirt
       ...
       <div className="table" style={{ background: "transparent",
                         width: "100%",
                          border: " solid #5f9ea0",
                          padding: "20px"}}>
...
{this.state.packing.map((packing,index)=>(
            <div class="col-sm-4">
              ...
              {/* <img
                ...
                <a className="btn btn-primary" href={`/packing/${packing._id}`} style={{textDecoration:'none'}}>
                <i class="fas fa-running"></i>&nbsp;View Packing Form Details
                  ...
                  <a className = "btn btn-warning" href = {`/edit/${packing._id}`}>
                      <i className = "fas fa-edit"></i>&nbsp;Edit
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;
                    <a className="btn btn-danger" href = "#" onClick={()=>this.onDelete(packing._id)}>
                    <i className="far fa-trash-alt"></i>&nbsp;Delete
