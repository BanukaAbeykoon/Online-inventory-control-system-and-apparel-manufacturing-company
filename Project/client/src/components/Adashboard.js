...
class Adashboard extends Component {
  render() {
    return (
      ...
      <div>
        <h2 > <center> <br/>CASANOVA ACCOUNTS</center> </h2>
        <hr/>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="%PUBLIC_URL%../../Amain1.png"  height="400" class="d-block w-100" alt="..."/>
    ...
    <div class="carousel-item">
      <img src="%PUBLIC_URL%../../Amain2.png"   height="400" class="d-block w-100" alt="..."/>
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="carousel-item">
      <img src="%PUBLIC_URL%../../Amain3.png" height="400" class="d-block w-100" alt="..."/>
      <div class="carousel-caption d-none d-md-block">
...
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="card">
                <img
                  src="%PUBLIC_URL%../../plcalculate.png"
                  width="300"
                  height="400"
                  class="card-img-top"
                  alt="..."
            ...
            <div class="col-sm-4">
              ...
              <img
                ...
                <h5 class="card-title">Future Decision </h5>
                  ...
                  <a href="/accountPlanHome" class="btn btn-primary">
                   Go Future Decision 
                  </a>
                </div>
              </div>
...
<img src="%PUBLIC_URL%../../acc.png" class="rounded-circle" width="40" height="40"  alt=""/>
  <h1>CASANOVA</h1>
